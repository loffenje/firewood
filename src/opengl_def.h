...
typedef void APIENTRY type_glTexImage2DMultisample(
...
typedef void APIENTRY type_glFramebufferTexture2D(GLenum target,
						  GLenum attachment,
						  GLenum textarget,
						  GLuint texture, GLint level);
typedef GLenum APIENTRY type_glCheckFramebufferStatus(GLenum target);
typedef void APIENTRY type_glBlitFramebuffer(GLint srcX0, GLint srcY0,
...
typedef void APIENTRY type_glShaderSource(GLuint shader, GLsizei count,
					  const GLchar **string, GLint *length);
typedef void APIENTRY type_glUseProgram(GLuint program);
typedef void APIENTRY type_glGetProgramInfoLog(GLuint program, GLsizei bufSize,
					       GLsizei *length,
					       GLchar *infoLog);
typedef void APIENTRY type_glGetShaderInfoLog(GLuint shader, GLsizei bufSize,
					      GLsizei *length, GLchar *infoLog);
typedef void APIENTRY type_glValidateProgram(GLuint program);
typedef void APIENTRY type_glGetProgramiv(GLuint program, GLenum pname,
					  GLint *params);
typedef GLint APIENTRY type_glGetUniformLocation(GLuint program,
						 const GLchar *name);
typedef void APIENTRY type_glUniform4fv(GLint location, GLsizei count,
					const GLfloat *value);
typedef void APIENTRY type_glUniformMatrix4fv(GLint location, GLsizei count,
					      GLboolean transpose,
					      const GLfloat *value);
typedef void APIENTRY type_glUniform1i(GLint location, GLint v0);
typedef void APIENTRY type_glUniform4f(GLint location, GLfloat v0, GLfloat v1,
				       GLfloat v2, GLfloat v3);
typedef void APIENTRY type_glUniform1f(GLint location, GLfloat v0);
typedef void APIENTRY type_glUniform2fv(GLint location, GLsizei count,
					const GLfloat *value);
typedef void APIENTRY type_glUniform3fv(GLint location, GLsizei count,
					const GLfloat *value);

typedef void APIENTRY type_glBufferSubData(GLenum target, GLintptr offset,
...
typedef GLint APIENTRY type_glGetAttribLocation(GLuint program,
						const GLchar *name);
typedef void APIENTRY type_glVertexAttribPointer(GLuint index, GLint size,
						 GLenum type,
						 GLboolean normalized,
						 GLsizei stride,
						 const void *pointer);
typedef void APIENTRY type_glVertexAttribIPointer(GLuint index, GLint size,
						  GLenum type, GLsizei stride,
						  const void *pointer);

typedef void APIENTRY type_glDeleteBuffers(GLsizei n, const GLuint *buffers);
typedef void APIENTRY type_glDeleteVertexArrays(GLsizei n,
						const GLuint *arrays);
...
typedef void APIENTRY type_glBufferData(GLenum target, GLsizeiptr size,
...
typedef void APIENTRY type_glDeleteFramebuffers(GLsizei n,
						const GLuint *framebuffers);
typedef void APIENTRY type_glDrawBuffers(GLsizei n, const GLenum *bufs);
typedef void APIENTRY type_glCreateTextures(GLenum target, GLsizei n,
					    GLuint *textures);
typedef void APIENTRY type_glTexStorage2D(GLenum target, GLsizei levels,
					  GLenum internalformat, GLsizei width,
					  GLsizei height);
typedef void APIENTRY type_glTexSubImage2D(GLenum target, GLint level,
					   GLint xoffset, GLint yoffset,
					   GLsizei width, GLsizei height,
					   GLenum format, GLenum type,
					   const void *pixels);
typedef void APIENTRY type_glBindTextureUnit(GLuint unit, GLuint texture);
typedef void APIENTRY type_glTexImage3D(GLenum target, GLint level,
					GLint internalformat, GLsizei width,
					GLsizei height, GLsizei depth,
					GLint border, GLenum format,
					GLenum type, const void *pixels);
typedef void APIENTRY type_glTexSubImage3D(GLenum target, GLint level,
					   GLint xoffset, GLint yoffset,
...
#define GL_DEBUG_CALLBACK(Name)                                                \
    void APIENTRY Name(GLenum source, GLenum type, GLuint id, GLenum severity, \
		       GLsizei length, const GLchar *message,                  \
		       const void *userParam)
typedef GL_DEBUG_CALLBACK(GL_DEBUG_PROC);
typedef void APIENTRY type_glDebugMessageCallbackARB(GL_DEBUG_PROC *callback,
						     const void *userParam);
typedef const GLubyte *APIENTRY type_glGetStringi(GLenum name, GLuint index);
typedef void APIENTRY type_glDrawElementsBaseVertex(GLenum mode, GLsizei count,
						    GLenum type,
						    const void *indices,
						    GLint basevertex);
...
void OpenGLRendererAPI::drawIndexed(VertexArray *vertex_array) {
    glDrawElements(GL_TRIANGLES, vertex_array->index_buffer->getCount(),
...
OpenGL *OpenGLRendererAPI::rendererAlloc(size_t size) {
    ...
    OpenGL *result =
	reinterpret_cast<OpenGL *>(memory != MAP_FAILED ? memory : 0);
...
#define SDL_GetOpenGLFunction(name) \
    context->name = (type_##name *)SDL_GL_GetProcAddress(#name)
